...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(413), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
...
"use strict";
module.exports = "data:image/svg+xml,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 width=%2716%27 height=%2716%27 viewBox=%270 0 16 16%27%3e%3cpath fill=%27none%27 stroke=%27rgba%280,0,0,.5%29%27 stroke-linecap=%27round%27 stroke-linejoin=%27round%27 stroke-width=%272%27 d=%27M5 14l6-6-6-6%27/%3e%3c/svg%3e";
...
var sidebarData = [{
  ...
  content: [{
    name: 'chat',
    content: ['chat buttons (static)', 'chat buttons (floating)', 'chat windows', 'automatic distribution', 'canned messages', 'wrap-up fields', 'routing rules', 'chat folders']
  }, {
    name: 'messaging',
    content: ['facebook messenger', 'SMS', 'automatic distribution', 'canned messages', 'wrap-up fields', 'routing rules', 'messaging folders']
  }, {
    name: 'email',
    content: ['email accounts', 'automatic distribution', 'canned messages', 'wrap-up fields', 'routing rules', 'email folders']
  }]
}, {
  name: 'customers',
  content: ['custom invitations', 'invitation rule sets', 'invitation settings', 'PIN invitaion', 'customer info card', 'conversion codes']
}, {
  name: 'general',
  content: ['login controls', 'single sign on', 'restrictions', 'data retention', 'data protection', 'transfer rules', 'outgoing email setup']
}, {
  name: 'intergrations',
...
var collapseButton = function collapseButton(item, content) {
  var ms = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
  return "\n    <li class='mb-1 ".concat(ms, "'>\n      <button\n        class='btn btn-toggle align-items-center rounded collapsed'\n        data-bs-toggle='collapse'\n        data-bs-target='#").concat(item.name, "-collapse'\n        aria-expanded='true'\n      >\n        ").concat(item.name, "\n      </button>\n      <div class='collapse' id='").concat(item.name, "-collapse'>\n        <ul class='btn-toggle-nav list-unstyled fw-normal pb-1 small'>\n        ").concat(content, "\n        </ul>\n      </div>\n    </li>\n    ");
};

var collapseButtonContent = function collapseButtonContent(item) {
  if (item.name === 'channels') {
    return item.content.map(function (i) {
      var content = collapseButtonContent(i);
      return collapseButton(i, content, 'ms-3');
    }).join('');
  }

  return item.content.map(function (el) {
    return "<li><a href='#' class='link-dark rounded'>".concat(el, "</a></li>");
  }).join('');
};

function populateSidebar(data) {
  data && data.forEach(function (item) {
    var content = collapseButtonContent(item);
...
function genNavLevelTow() {
  return _genNavLevelTow.apply(this, arguments);
}

function _genNavLevelTow() {
  _genNavLevelTow = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee() {
    var res, data, navItems, DomNavItems;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            data = _context.sent;
            slides = data.slides;
            navItems = data.slides.map(function (slide) {
              return "\n    <div \n    title='".concat(slide.name, "'\n    id='").concat(slide._id, "'\n    class='to-media col text-center border rounded text-truncate px-2 mx-2'>\n    ").concat(slide.name, "\n    </div>\n    ");
            }).join('');
            navLevelTwoEl.innerHTML = navItems;
            DomNavItems = document.querySelectorAll('.to-media');
            DomNavItems.forEach(function (item) {
