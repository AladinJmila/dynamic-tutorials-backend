...
function audioPlayer(state) {
  ...
  canvas.addEventListener('click', function () {
    return playSlide(state.mode === 'viewer');
  });
  ...
  state.mode === 'viewer' ? expandBtn.style.display = 'block' : expandBtn.style.display = 'none'; // if (state.mode === 'viewer') {
  //   expandBtn.style.display = 'block';
  // }
}
