  ...
  if (state.mode === 'editor') {
    ...
    ['dragenter', 'dragover'].forEach(function (eventName) {
      dropArea.addEventListener(eventName, function () {
        canvas.classList.contains('show') && dropArea.classList.add('highlight');
      });
    });
...
function slidesEditor(state) {
  ...
  resizeCanvas(); // imageObj.src = '/images/sakura.jpg';
...
function slidesModeToggle(state) {
  ...
  var showInEditorBlock = [incanvasSlideName, baseSelect, incanvasSlideId, placeHolder, slideSubmitBtn, notesTextarea, recordBtn];
...
;// CONCATENATED MODULE: ./src/UI/featuresActions.js
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 18:
              ...
              _context.next = 23;
              return fetch("/feature/upload-image/".concat(state.selectedFeature), {
                method: 'POST',
                body: formData
              });
